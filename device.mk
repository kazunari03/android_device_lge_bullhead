...
PRODUCT_COPY_FILES += \
    device/lge/bullhead/rootdir/init.qcom.devwait.sh:$(TARGET_COPY_OUT_VENDOR)/bin/init.qcom.devwait.sh \
    device/lge/bullhead/rootdir/init.qcom.devstart.sh:$(TARGET_COPY_OUT_VENDOR)/bin/init.qcom.devstart.sh
...
# For SPN display
PRODUCT_COPY_FILES += \
    device/lge/bullhead/spn-conf.xml:$(TARGET_COPY_OUT_VENDOR)/etc/spn-conf.xml
...
PRODUCT_COPY_FILES += \
    device/lge/bullhead/rootdir/init.bullhead.power.sh:$(TARGET_COPY_OUT_VENDOR)/bin/init.bullhead.power.sh

# MBN
PRODUCT_COPY_FILES += \
    device/lge/bullhead/rootdir/init.bullhead.sh:$(TARGET_COPY_OUT_VENDOR)/bin/init.bullhead.sh

# Qseecomd configuration file
PRODUCT_COPY_FILES += \
    device/lge/bullhead/rootdir/init.bullhead.qseecomd.sh:$(TARGET_COPY_OUT_VENDOR)/bin/init.bullhead.qseecomd.sh
...
PRODUCT_COPY_FILES += \
# Bluetooth configs
    device/lge/bullhead/bluetooth/bt_did.conf:$(TARGET_COPY_OUT_VENDOR)/etc/bluetooth/bt_did.conf \
    device/lge/bullhead/bluetooth/bt_stack.conf:$(TARGET_COPY_OUT_VENDOR)/etc/bluetooth/bt_stack.conf
